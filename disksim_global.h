...
typedef struct disksim {
   ...
   void   (*external_io_done_notify)(ioreq_event *curr);
   FILE * parfile;
   FILE * iotracefile;
   FILE * statdeffile;
   FILE * outputfile;
...
//Sept.10, 1gb flash_only oltp
#define F_COEFF_INTARR_T    (-0.00007)
#define F_COEFF_RW_T        (-0.66566)
#define F_COEFF_SEQ_T       (-0.78597)
#define F_COEFF_DS_PREV_T   (0.01223)
#define F_COEFF_REQ_SIZE_T  (0.12127)
#define F_INTERCEPT         (0.13145) 
//disk for oltp
#define D_AVG_RESP  3.397877

//youkim-data manager table size
//#define DM_MGR_SIZE 33554432    // number of sectors for 16gb
#define DM_MGR_SIZE 1048576    // number of sectors for 512mb
//#define DM_MGR_SIZE 67108864    // number of sectors for 32GB  268435456
//#define DM_MGR_SIZE 268435456    // number of sectors for 128GB
#define DEV_FLASH   1 
#define DEV_DISK    0 

int dm_table[DM_MGR_SIZE];
